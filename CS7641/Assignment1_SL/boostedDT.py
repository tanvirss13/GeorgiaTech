...
class BoostedDecisionTree:
    ...
    def train_boosted_decision_tree(self):
        self.tree_clf = GradientBoostingClassifier(max_depth=9, min_samples_split=7, min_samples_leaf=5)
    ...
    def validate_boosted_decision_tree(self):
        ...
        train_scores, test_scores = validation_curve(
            GradientBoostingClassifier(max_depth=9, min_samples_split=7, min_samples_leaf=5),
...
if __name__ == '__main__':
    app = BoostedDecisionTree('/Users/tanvirsethi/Desktop/Almost all Docs/Georgia Institute of Technology-MSCS/GaTech_Codework/GeorgiaTech/CS7641/Assignment1_SL/^GSPC.csv')
